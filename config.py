...
# default : data: FB15k, model: transE, score: L2
# data params
tf.flags.DEFINE_string("data_file", 'data/WN18/train.txt', "data dir")
tf.flags.DEFINE_string("entity_vocab", 'data/WN18/entity.vocab', "entity vocab file")
tf.flags.DEFINE_string("relation_vocab", 'data/WN18/relation.vocab', "relation vocab file")
...
# model params
tf.flags.DEFINE_string("model_name", "transH", "model name: `transE`|`transH`|`transR`|`distmult`.")
