...
# default : data: FB15k, model: transR, score: L2
# data params
...
# model params
tf.flags.DEFINE_string("model_name", "transR", "model name: `transE`|`transH`|`transR`.")
...
# training params
tf.flags.DEFINE_integer("batch_size", 128, "train batch size [64]")
